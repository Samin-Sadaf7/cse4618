...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        self.visitedCorners = {} # a dictionary to keep track of the visited corners
        for corner in self.corners: 
            self.visitedCorners[corner] = False #none of the corner is visited 
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        currPos, currVisitedCorners = state #unpacking the state and getting two values 
        for corner in self.corners:
...
def cornersHeuristic(state, problem):
    ...
    for corner in corners:
        if currVisitedCorners[corner] == False:
            max_distance = max( max_distance, abs((currentX-corner[0])) + abs((currentY-corner[1])))
...
def foodHeuristic(state, problem):
    ...
    for i in foodGrid.asList():
        ...
        max_val = max(max_val, mazeDistance(position, i, problem.startingGameState))
